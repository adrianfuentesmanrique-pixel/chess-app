    ...
    lessons: [
      ...
      },
      {
        ...
        hint: {
          ...
          en: 'The core idea: together, the bishops limit the enemy king\'s space and push it toward a corner. Near the actual mate it\'s normal to split them apart for the final blow — if you\'re not making headway, think about whether the enemy king is still losing space.',
        },
      ...
      },
      {
        ...
        hint: {
          ...
          en: 'The core idea: the enemy king can only be mated in the corner matching your bishop\'s color. If you\'ve gone a while without progress, check whether you\'re actually steering it toward that specific corner.',
        },
